...
export async function POST(req: NextRequest) {
  ...
  const { shopName, slug, ownerEmail, ownerPhone, password } = body
  const templateId = body.templateId || 'booking-service'

  if (!shopName || !slug || !ownerPhone || !ownerEmail || !password) {
