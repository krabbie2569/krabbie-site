  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FDFBFF', fontFamily: 'Sarabun, sans-serif', color: '#1a1a2e' }}>
      ...
      <div style={{ background: GRAD, color: 'white', padding: '8px 16px', fontSize: '0.72rem', fontWeight: 700, letterSpacing: '1px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <span style={{ letterSpacing: '2px' }}>✦ ตัวอย่าง Template · ระบบเช่าสินค้า</span>
        <a href="/dashboard/new?template=booking-rental" style={{ color: 'rgba(255,255,255,0.85)', textDecoration: 'underline' }}>ใช้ template →</a>
      </div>
